...
const RecaudoDetail: React.FC<RecaudoDetailProps> = ({ id, estado, funCloseInfo }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <Card className="relative w-full max-w-3xl p-6 bg-white rounded-lg shadow-lg">
        <h1 className="text-2xl font-bold mb-4">Detalle Recaudo</h1>
        <div className="space-y-2">
          ...
          <article className="font-medium text-gray-700 p-2 rounded-md bg-red-100">
